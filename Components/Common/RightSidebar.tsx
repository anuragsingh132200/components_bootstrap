                    ...
                    <Offcanvas.Body className="p-0">
                        <SimpleBar className="h-100">
                            <div className="p-4">
                                ...
                                <p className="text-muted fs-13 fs-13">Choose your layout</p>
                                ...
                                <h6 className="mt-4 fw-semibold">Color Scheme</h6>
                                <p className="text-muted fs-13 fs-13">Choose Light or Dark Scheme.</p>
