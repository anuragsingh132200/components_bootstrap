                        ...
                        {!item['isHeader'] ?
                            (item.subItems ? (
                                <li className="nav-item">
                                    ...
                                    <Collapse
                                        className={item.id === "boostrapui" && item.subItems.length > 8 ? "menu-dropdown mega-dropdown-menu" : "menu-dropdown"} in={item.stateVariables}>
                                        {/* subItms  */}
                                        {item.id === "boostrapui" && item.subItems.length > 8 ? (
                                            <React.Fragment>
