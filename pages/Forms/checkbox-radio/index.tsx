...
// import { Checkbox,  CustomCheckbox, Radio, CustomRadio, Switches, SwitchColor, CustomSwitches, InlineCheckboxRadio, WithoutLabels, RadioToggleButtons, OutlinedStyles } from './CheckboxAndRadioCode';
...
import CustomSwitches from './CustomeSwitches';
import InlineCheckboxRadio from './InlineCheckboxRadio';
import WithoutLabels from './WithoutLabels';
import RadioToggleButtons from './RadioToggleButtons';
import OutlinedStyles from './OutlineStyles';
        ...
        <React.Fragment>
            <div className="page-content">
                <Container fluid={true}>
                    ...
                    <Head>
                        <title>CheckBox & Radio | Hybrix - Admin & Dashboard Template</title>
                    </Head>
