...
import StacksVerticalExample from './stacksVerticalCode';
import StacksHorizontalExample from './stacksHorizontalCode';
import TextSelectionExample from './textSelectionCode';
import PointerEventsExample from './pointerEventsCode';
import OverflowExample from './overflowCode';
import PositionExample from './positionCode';
import ShadowsExample from './shadowsCode';
...
const uiUtilities = () => {
    ...
    return (
        <React.Fragment>
            ...
            <Head>
                <title>Utilities | Hybrix - Admin & Dashboard Template</title>
            </Head>

            <div className="page-content">
                <Container fluid={true}>
                    <Breadcrumb breadcrumb="Bootstrap Ui" breadcrumbItem="Utilities" />
