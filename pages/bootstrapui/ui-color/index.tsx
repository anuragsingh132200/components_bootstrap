...
const uiColor = () => {
    return (
        <React.Fragment>
            ...
            <Head>
                <title>Color | Hybrix - Admin & Dashboard Template</title>
            </Head>

            <div className="page-content">
                <Container fluid={true}>
                    <Breadcrumb breadcrumb="Bootstrap Ui" breadcrumbItem="Colors" />
                    <Row>
                        <Col lg={12}>
                            <Card>
                                <Card.Header>
                                ...
                                <Card.Body>
                                    <div className="table-responsive">
                                        <Table className="table-bordered table-striped table-nowrap align-middle mb-0">
                                        <thead>
                                                <tr>
                                                    <th scope="col">
                                                        Colors
