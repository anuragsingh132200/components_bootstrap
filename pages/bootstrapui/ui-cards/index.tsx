...
const UiCards = () => {
    ...
    return (
        <React.Fragment>
            ...
            <Head>
                <title>Cards | Hybrix - Admin & Dashboard Template</title>
            </Head>

            <div className="page-content">
                <Container fluid={true}>
                    <Breadcrumb breadcrumb="Bootstrap Ui" breadcrumbItem="Cards" />

                    <Row>
                        <Col sm={6} xl={3}>
                            <Card>
                                <Image src={img1} className="card-img-top img-fluid" alt="Card image cap" />
                                <Card.Body>
                        ...
                        <Col sm={6} xl={3}>
                            <Card>
                                <Image className="card-img-top img-fluid" src={img2} alt="Card image cap" />
                                <Card.Body>
                        ...
                        <Col sm={6} xl={3}>
                            <Card>
                                <Image className="card-img-top img-fluid" src={img3} alt="Card image cap" />
                                <Card.Body>
                        ...
                        <Col sm={6} xl={3}>
                            <Card>
                                ...
                                <Image className="img-fluid" src={img4} alt="Card image cap" />
                                <Card.Body>
                            ...
                            <Card>
                                ...
                                <div className="card-footer">
                                    <div className="hstack gap-2 justify-content-end">
                                        ...
                                        <Link href="javasceript:void(0);" className="btn btn-primary btn-sm">Read More</Link>
                                    </div>
                                </div>
                            </Card>
                        </Col>
                    ...
                    <Row>
                            ...
                            <Card>
                                ...
                                <Card.Body className="p-4 text-center">
                                    <div className="mx-auto avatar-md mb-3">
                                        <Image src={avtar8} alt="" className="img-fluid rounded-circle" />
                                    </div>
                        ...
                        <Col xl={4}>
                            <Card>
                                ...
                                <Card.Body className="p-4 text-center">
                                    <div className="mx-auto avatar-md mb-3">
                                        <Image src={avtar5} alt="" className="img-fluid rounded-circle" />
                                    </div>
                        ...
                        <Col xl={4}>
                            <Card>
                                ...
                                <Card.Body className="p-4 text-center">
                                    <div className="mx-auto avatar-md mb-3">
                                        <Image src={avtar3} alt="" className="img-fluid rounded-circle" />
                                    </div>
                    ...
                    <Row>
                                    ...
                                    <div className="d-flex align-items-center">
                                        ...
                                        <div className="flex-shrink-0">
                                            <ul className="list-inline card-toolbar-menu d-flex align-items-center mb-0">
                                                <li className="list-inline-item">
                                                    <Link className="align-middle" href="#" onClick={() => spinner('customer-loader')} scroll={false}>
                                                        <i className="mdi mdi-refresh align-middle"></i>
                                                    </Link>
                                                </li>
                                                <li className="list-inline-item">
                                                    <Link className="align-middle minimize-card" href="#" scroll={false} onClick={() => setCol1(!col1)}>
                                ...
                                <Card.Header>
                                    <div className="d-flex align-items-center">
                                        ...
                                        <div className="flex-shrink-0">
                                            <ul className="list-inline card-toolbar-menu d-flex align-items-center mb-0">
                                                <li className="list-inline-item">
                                                    <Link className="align-middle" href="#" onClick={() => spinner("growing-reload")} scroll={false}>
                                                        <i className="mdi mdi-refresh align-middle"></i>
                                                    </Link>
                                                </li>
                                                <li className="list-inline-item">
                                                    <Link className="align-middle minimize-card" href="#" scroll={false} onClick={() => setCol2(!col2)}>
                                                        <i className="mdi mdi-plus align-middle plus"></i>
                                                        <i className="mdi mdi-minus align-middle minus"></i>
                                                    </Link>
                                                </li>
                        ...
                        <Col xl={4} id="card-none3">
                            <Card>
                                <Card.Header>
                                    <div className="d-flex align-items-center">
                                        ...
                                        <div className="flex-shrink-0">
                                            <ul className="list-inline card-toolbar-menu d-flex align-items-center mb-0">
                                                <li className="list-inline-item">
                                                    <Link className="align-middle" href="#" onClick={() => spinner('spinner3')} scroll={false}>
                                                        <i className="mdi mdi-refresh align-middle"></i>
                                                    </Link>
                                                </li>
                                                <li className="list-inline-item">
                                                    <Link className="align-middle minimize-card" href="#" scroll={false} onClick={() => setCol3(!col3)}>
                                                        <i className="mdi mdi-plus align-middle plus"></i>
                                                        <i className="mdi mdi-minus align-middle minus"></i>
                                                    </Link>
                                                </li>
                                        ...
                                        <div className="card-preloader d-none" id='spinner3'>
                                            <div className="card-status">
                                                <Image src={spinner1} alt="" className="img-fluid custom-loader" />
                                            </div>
                                        </div>
                                    </div>
                                </Card.Header>
                                ...
                                {/* <Card.Body className="collapse show" id="collapseExample3">
                                    <div className="d-flex">
                                        <div className="flex-shrink-0">
                                            <i className="ri-checkbox-circle-fill text-success"></i>
                                        </div>
                            ...
                            <Row>
                                <Col xxl={4} lg={6} className="col-xxl-4 col-lg-6">
                                    <Card className="card-overlay">
                                        <Image className="card-img img-fluid" src={img12} alt="Card image" />
                                ...
                                <Col xxl={4} lg={6}>
                                    <Card className="card-overlay">
                                        <Image className="card-img img-fluid" src={img1} alt="Card image" />
                                ...
                                <Col xxl={4} lg={6}>
                                    <Card className="card-overlay">
                                        <Image className="card-img img-fluid" src={img5} alt="Card image" />
                            ...
                            <Row>
                                ...
                                <Col xxl={4} lg={6}>
                                    <Card>
                                        ...
                                        <Image className="card-img-bottom img-fluid" src={img7} alt="Card image cap" />
                                    </Card>
                                </Col>
                                ...
                                <Col xxl={4} lg={6}>
                                    <Card>
                                        ...
                                        <Image className="card-img rounded-0 img-fluid" src={img8} alt="Card image cap" />
                                        <div className="card-footer">
                                ...
                                <Col xxl={4} lg={6}>
                                    <Card>
                                        ...
                                        <Image className="card-img rounded-0 img-fluid" src={img10} alt="Card image cap" />
                                        <div className="card-footer">
                                            <p className="card-text mb-0">
                                                Last updated 3 mins ago
                                            </p>
                                ...
                                <Col xxl={4} lg={6}>
                                    <Card>
                                        <Image className="card-img-top img-fluid" src={img11} alt="Card image cap" />
                                        <Card.Header>
                                            <h4 className="card-title mb-0">A day in the of a professional fashion designer</h4>
                                        </Card.Header>
                                        <Card.Body>
                                ...
                                <Col xxl={4} lg={6}>
                                    <Card>
                                        ...
                                        <Image className="card-img-bottom img-fluid" src={img11} alt="Card image cap" />
                                    </Card>
                                </Col>
                            </Row>
                        </div>
                            ...
                            <Row>
                                <Col xxl={6}>
                                    <Card>
                                        <Row className="g-0">
                                            <Col md={4}>
                                                <Image className="rounded-start img-fluid h-100 object-cover" src={img12} alt="Card image" />
                                            </Col>
                                            <Col md={8}>
                                                <Card.Header>
                                ...
                                <Col xxl={6}>
                                    <Card>
                                        <Row className="g-0">
                                            ...
                                            <Col md={4}>
                                                <Image className="rounded-end img-fluid h-100 object-cover" src={img4} alt="Card image" />
                                            </Col>
                                        </Row>
                                    </Card>
                                </Col>
                                ...
                                <Col xxl={6}>
                                    <Card>
                                        <Row className="g-0">
                                            <Col md={4}>
                                                <Image className="rounded-start img-fluid h-100 object-cover" src={img9} alt="Card image" />
                                            </Col>
                                            <Col md={8}>
                                                <Card.Body>
                                ...
                                <Col xxl={6}>
                                    <Card>
                                        <Row className="g-0">
                                            ...
                                            <Col md={4}>
                                                <Image className="rounded-end img-fluid h-100 object-cover" src={img2} alt="Card image" />
                                            </Col>
                                        </Row>
                                    </Card>
                                </Col>
                        ...
                        <Col xxl={4}>
                            <Card className="card-secondary">
                                <Card.Body>
                                    <div className="d-flex align-items-center">
                                        <div className="flex-shrink-0">
                                            <Image src={avtar7} alt="" className="avatar-sm rounded-circle" />
                                        </div>
                                        <div className="flex-grow-1 ms-3">
                        ...
                        <Col xxl={4}>
                            <Card className="card-light">
                                <Card.Body>
                                    <div className="d-flex align-items-center">
                                        <div className="flex-shrink-0">
                                            <Image src={avtar8} alt="" className="avatar-sm rounded-circle" />
                                        </div>
                                        <div className="flex-grow-1 ms-3">
                                ...
                                <div className="card-footer">
                                    <div className="text-center">
                                        <Link href="#" className="link-dark">Connect Now <i className="ri-arrow-right-s-line align-middle lh-1"></i></Link>
                                    </div>
                                </div>
                            </Card>
                        </Col>
                        ...
                        <Col xxl={4}>
                            <Card className="border card-border-dark">
                                ...
                                <Card.Body>
                                    <p className="card-text">They all have something to say beyond the words on the page. They can come across as casual or neutral, exotic or graphic. Cosby sweater eu banh mi, qui irure terry richardson ex squid.</p>
                                    <div className="text-end">
                                        <Link href="#" className="link-dark fw-medium">Read More <i className="ri-arrow-right-line align-middle"></i></Link>
                                    </div>
                                </Card.Body>
                            </Card>
                        </Col>
                    ...
                    <Row>
                        <Col className="col-12">
                            ...
                            <Row>
                                <Col xl={4}>
                                    <Card>
                                        <Image src={img3} className="img-fluid card-img-top" alt="..." /> 
                                        <Card.Body>
                                            <h5 className="card-title">Card with stretched link</h5>
                                            <p className="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                                            <Link href="#" as='button' className="btn-primary stretched-link">Go somewhere</Link>
                                        </Card.Body>
                                    </Card>
                                </Col>
                                <Col xl={8}>
                                    <Card>
                                        <Card.Body>
                                            <div className="d-flex position-relative">
                                                <Image src={avtar3} className="flex-shrink-0 me-3 avatar-xl rounded" alt="..." />
                                                <div>
                                    ...
                                    <Card>
                                        <Card.Body>
                                            <Row className="g-0 bg-light position-relative">
                                                <Col md={5}>
                                                    <Image src={img4} className="rounded-start img-fluid" alt="..." />
                                                </Col>
