...
import DefaultOffcanvasExample from './defaultOffcanvasCode';
import PlacementOffcanvasExample from './placementOffcanvasCode';
import BackdropOffcanvasExample from './backdropOffcanvasCode';
...
const UiOffcanvas = () => {
    ...
    return (
        <React.Fragment>
            ...
            <Head>
                <title>Offcanvas | Hybrix - Admin & Dashboard Template</title>
            </Head>

            <div className="page-content">
                <Container fluid={true}>
                    <Breadcrumb breadcrumb="Bootstrap Ui" breadcrumbItem="Offcanvas" />
                            ...
                            <Card>
                                ...
                                <Card.Body>
                                    ...
                                    <div className="hstack flex-wrap gap-2">
                                        <Link className="btn btn-secondary" onClick={handleShow} href="#offcanvasExample">
                                            Link with href
                                        </Link>
                                                ...
                                                <div className="acitivity-timeline p-4">
                                                    ...
                                                    <div className="acitivity-item py-3 d-flex">
                                                        ...
                                                        <div className="flex-grow-1 ms-3">
                                                            ...
                                                            <p className="text-muted mb-2">added a new member to Hybrix dashboard</p>
