...
import BasicRaterExample from './BasicRaterExample';
import RaterWithStepExample from './RaterWithStepExample';
import CustomMsgExample from './CustomMsgExample';
import ReadOnlyRaterExample from './ReadOnlyRaterExample';
import OnHoverExample from './OnHoverExample';
import ReasetRaterExample from './ReasetRaterExample';
const UiRatings = () => {
    ...
    return (
        <React.Fragment>
            ...
            <Head>
                <title>Ratings | Hybrix - Admin & Dashboard Template</title>
            </Head>
